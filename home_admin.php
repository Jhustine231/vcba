...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <h3 class="title">Teacher Schedules</h3>
         <a href="teacher-schedule\add-new.php" class="btn btn-dark mb-3">Add New</a>
                ...
                <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $row["teach_day"] ?></td>
                        <td>
                          <a href="teacher-schedule\edit.php?id=<?php echo $row["id"] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                          <a href="teacher-schedule\delete.php?id=<?php echo $row["id"] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
                        </td>
                      </tr>
                    <?php
                    }
